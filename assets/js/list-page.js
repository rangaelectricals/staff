      ...
      return `<tr>
        ...
        <td>
          <div class="flex flex-wrap gap-1.5">
            <a href="${profileLink(staff.id)}" class="btn btn-xs bg-slate-800 hover:bg-slate-700 text-white border-none gap-1">
            ...
            <a href="add-staff.html?id=${encodeURIComponent(staff.id)}" class="btn btn-xs btn-outline gap-1">
            ...
            <button class="btn btn-xs btn-outline text-orange-600 border-orange-200 hover:bg-orange-50 gap-1" data-docs="${staff.id}">
              <svg class="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
              Docs
            </button>
            <button class="btn btn-xs btn-error btn-outline gap-1 hover:text-white" data-delete="${staff.id}">
      ...
      return `<article class="sys-card">
        <div class="p-4">
          <div class="flex items-center gap-3 mb-3">
            <a href="${viewUrl}" target="_blank" rel="noopener noreferrer">
              <img class="staff-thumb" style="width:52px;height:52px;" src="${photoSrc}" alt="${staff.fullName || ''}"
                loading="lazy" onerror="this.onerror=null;this.src='${AVATAR_SVG}'" />
            </a>
          ...
          <div class="flex flex-wrap gap-1.5">
            ...
            <button class="btn btn-xs btn-outline text-orange-600 border-orange-200 gap-1" data-docs="${staff.id}">
              <svg class="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
              Docs
            </button>
            <button class="btn btn-xs btn-error btn-outline gap-1 hover:text-white" data-delete="${staff.id}">
